...
class CreateVanchuyenTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_vanchuyen', function (Blueprint $table) {
            ...
            $table->timestamp('vc_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo dịch vụ giao hàng');
            $table->timestamp('vc_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật dịch vụ giao hàng gần nhất');
