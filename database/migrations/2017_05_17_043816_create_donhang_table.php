...
class CreateDonhangTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_donhang', function (Blueprint $table) {
            ...
            $table->dateTime('dh_thoiGianDatHang')->nullable()->comment('Thời điểm đặt hàng # Thời điểm đặt hàng');
            ...
            $table->timestamp('dh_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo đơn hàng');
            $table->timestamp('dh_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật đơn hàng gần nhất');
