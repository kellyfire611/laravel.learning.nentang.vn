...
class CreateMauTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_mau', function (Blueprint $table) {
            ...
            $table->timestamp('m_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo màu');
            $table->timestamp('m_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật màu gần nhất');
