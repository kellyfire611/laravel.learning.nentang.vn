...
class CreateNhacungcapTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_nhacungcap', function (Blueprint $table) {
            ...
            $table->timestamp('ncc_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo nhà cung cấp');
            $table->timestamp('ncc_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật nhà cung cấp gần nhất');
