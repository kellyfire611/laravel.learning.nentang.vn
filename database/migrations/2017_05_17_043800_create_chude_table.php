...
class CreateChudeTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_chude', function (Blueprint $table) {
            ...
            $table->timestamp('cd_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo chủ đề');
            $table->timestamp('cd_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật chủ đề gần nhất');
