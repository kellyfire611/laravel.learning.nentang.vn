...
class CreateQuyenTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_quyen', function (Blueprint $table) {
            ...
            $table->timestamp('q_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo quyền');
            $table->timestamp('q_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật quyền gần nhất');
