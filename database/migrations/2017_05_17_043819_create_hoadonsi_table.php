...
class CreateHoadonsiTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_hoadonsi', function (Blueprint $table) {
            ...
            $table->dateTime('hds_ngayXuatHoaDon')->nullable()->comment('Thời điểm xuất # Thời điểm xuất hóa đơn');
            ...
            $table->timestamp('hds_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo hóa đơn');
            $table->timestamp('hds_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật hóa đơn gần nhất');
