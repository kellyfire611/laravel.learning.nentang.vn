...
class CreateLoaiTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_loai', function (Blueprint $table) {
            ...
            $table->timestamp('l_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo loại sản phẩm');
            $table->timestamp('l_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật loại sản phẩm gần nhất');
