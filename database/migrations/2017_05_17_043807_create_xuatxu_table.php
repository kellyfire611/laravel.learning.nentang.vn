...
class CreateXuatxuTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_xuatxu', function (Blueprint $table) {
            ...
            $table->timestamp('xx_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo xuất xứ');
            $table->timestamp('xx_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật xuất xứ gần nhất');
