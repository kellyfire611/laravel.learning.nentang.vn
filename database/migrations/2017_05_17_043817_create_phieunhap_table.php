...
class CreatePhieunhapTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_phieunhap', function (Blueprint $table) {
            ...
            $table->dateTime('pn_ngayXuatHoaDon')->nullable()->comment('Ngày xuất hóa đơn # Ngày xuất hóa đơn');
            ...
            $table->dateTime('pn_ngayLapPhieu')->nullable()->comment('Thời điểm lập phiếu # Thời điểm lập phiếu nhập kho');
            ...
            $table->timestamp('pn_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo phiếu nhập');
            $table->timestamp('pn_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật phiếu nhập gần nhất');
