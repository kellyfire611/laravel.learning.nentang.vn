...
class CreateKhachhangTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_khachhang', function (Blueprint $table) {
            ...
            $table->dateTime('kh_ngaySinh')->nullable()->comment('Ngày sinh # Ngày sinh');
            ...
            $table->timestamp('kh_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo khách hàng');
            $table->timestamp('kh_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật khách hàng gần nhất');
