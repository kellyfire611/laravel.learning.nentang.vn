...
class CreateSanphamTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_sanpham', function (Blueprint $table) {
            ...
            $table->timestamp('sp_taoMoi')->nullable()->comment('Thời điểm tạo # Thời điểm đầu tiên tạo sản phẩm');
            $table->timestamp('sp_capNhat')->nullable()->comment('Thời điểm cập nhật # Thời điểm cập nhật sản phẩm gần nhất');
